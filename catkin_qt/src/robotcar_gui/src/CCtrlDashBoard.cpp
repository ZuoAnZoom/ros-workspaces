#include "../include/robotcar_gui/CCtrlDashBoard.h"
#include <QPainter>
#include <QDebug>
#include <qmath.h>
...
CCtrlDashBoard::CCtrlDashBoard(QWidget *parent, StyleType type) :
    ...
    m_StyleType(type)
{
    m_BorderColor = QColor(60,60,60);//172
    m_BgColor = QColor(160,160,160);//40
    m_FrontColor = Qt::white;
    m_speedColor = Qt::white;
    m_DashValue= 0;
    m_MinValue = 0;
    m_MaxValue = 100;
    m_DashNum = 1;
...
void CCtrlDashBoard::drawBackGround(QPainter *painter, qreal hlafWidth)
{
    ...
    m_MinBorderRadius = m_MaxBorderRadius-20;//15
